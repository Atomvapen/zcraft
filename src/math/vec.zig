// ------------------------------------------------------------------------------
// Raylib compatability functions
// ------------------------------------------------------------------------------
//
// rlTransform (self: anytype, comptime Target: type) Target
//
// ------------------------------------------------------------------------------
...
pub inline fn dimensions(T: type) comptime_int {
    return @typeInfo(T).vector.len;
}

pub inline fn Element(T: type) type {
